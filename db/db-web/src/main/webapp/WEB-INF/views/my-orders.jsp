										...
										<c:forEach items="${orders}" var="order" varStatus="statusO">
											...
											<tr id="track2538292730" oty="0,1,70" class="tr-td">
												...
												<td id="operate2538292730" class="order-doi" width="100">
													...
													href="http://mydb.db.com/repair/ordersearchlist.action?searchString=2538292730"
													target="_blank"
...
<script type="text/javascript">
	...
	function doTr(order) {
		...
		var tdThree = $("<td id='operate2538292730' class='order-doi' width='100'><span id='pay-button-2538292730' state=''></span>"
				+ "<a target='_blank' href='http://order.db.com/normal/item.action?orderid=2538292730&amp;PassKey=769448C6BA99F1ADA8244BAE7BC60580'"
				...
				+ "<a style='cursor: pointer;'>删除</a></span><span id='doi2538292730'><br><a href='http://club.db.com/JdVote/TradeComment.aspx?ruleid=2538292730&amp;ot=0&amp;payid=1&amp;shipmentid=70'"
				+ "target='_blank' clstag='click|keycount|orderinfo|order_comment'>评价晒单</a><br></span><a href='http://mydb.db.com/repair/ordersearchlist.action?searchString=2538292730'"
				+ "target='_blank' clstag='click|keycount|orderinfo|order_repair'>申请返修/退换货</a><a class='btn-again' clstag='click|keycount|orderlist|buy'"
